  ...
  return (
    <div className="min-h-screen bg-transparent px-8 py-6 relative">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/2">
          <h2 className="text-white text-xl font-bold mb-4">INSTALLATION</h2>
          <div className="space-y-2.5">
            <div className="bg-white/10 border border-white/10 rounded-md p-6">
              <div className="flex items-center justify-between mb-5">
                <h3 className="text-xl text-white font-bold">FOR DEVELOPERS</h3>
                <button
            ...
            <div className="bg-white/10 border border-white/10 rounded-md p-6">
              <div className="flex items-center justify-between mb-5">
                <h3 className="text-xl text-white font-bold">FOR TRADERS</h3>
                <button className="bg-white text-black px-5 py-3 rounded-full text-sm font-bold flex items-center gap-2 min-w-[150px] justify-center">
                  <img src="/plus_black.svg" alt="Add" width={20} height={20} />
                  ADD AGENT
                </button>
              </div>
              <p className="text-gray-400 text-sm mb-4">
                Add this agent, go to 'Create an Agent' tab, and prompt how you
                want this dapp to trade for you.
              </p>
            </div>
          </div>
        </div>
